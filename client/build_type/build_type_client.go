...
*/
func (a *Client) GetCurrentVcsInstancesObsolete(params *GetCurrentVcsInstancesObsoleteParams) (*GetCurrentVcsInstancesObsoleteOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
	...
	return result.(*GetCurrentVcsInstancesObsoleteOK), nil
